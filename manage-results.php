            ...
            <div class="main-page">
                <div class="container-fluid">
                    <div class="row page-title-div">
                        <div class="col-md-6">
                            <h2 class="title">Manage Ratings</h2>
                    ...
                    <div class="row breadcrumb-div">
                        <div class="col-md-6">
                            <ul class="breadcrumb">
                                ...
                                <li> Ratings</li>
                                <li class="active">Manage Ratings</li>
                            </ul>
                        </div>
                                ...
                                <div class="panel">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <h5>View Ratings Information</h5>
                                        </div>
                                    </div>
                                    <?php if ($msg) { ?>
                                                    ...
                                                    foreach ($results as $result) {   ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <!-- <a href="delete-subject.php?subjectid=<?php echo htmlentities($result->id); ?>" class="btn btn-danger" onclick="return confirm('¿Estás seguro de que deseas eliminar este curso?')"><i class="fa fa-trash" title="Delete Record"></i></a> -->
                                                            </td>
                                                        </tr>
                                                <?php $cnt = $cnt + 1;
                                                    }
