            ...
            <div class="main-page">
                <div class="container-fluid">
                    <div class="row page-title-div">
                        <div class="col-md-6">
                            <h2 class="title">Manage of students</h2>
                    ...
                    <div class="row breadcrumb-div">
                        <div class="col-md-6">
                            <ul class="breadcrumb">
                                ...
                                <li> Students</li>
                                <li class="active">Manage of Students</li>
                            </ul>
                        </div>
                                ...
                                <div class="panel">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <h5>View Student Information</h5>
                                        </div>
                                    </div>
                                    <?php if ($msg) { ?>
                                                    ...
                                                    foreach ($results as $result) {   ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="delete-student.php?stid=<?php echo htmlentities($result->StudentId); ?>" class="btn btn-danger" onclick="return confirm('¿Estás seguro de que deseas eliminar este curso?')"><i class="fa fa-trash" title="Delete Record"></i></a>
                                                            </td>
                                                        </tr>
                                                <?php $cnt = $cnt + 1;
                                                    }
