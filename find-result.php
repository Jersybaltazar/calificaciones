        ...
        <div class="login-bg-color">
            <div class="row">
                <div class="col-md-4 col-md-offset-7">
                    <div class="panel login-box" style="background: #06457c;">
                        <div class="panel-heading">
                            <div class="panel-title text-center">
                                <a href="#">
                                    <!-- <img style="height: 70px" src="assets/images/footer-logo.png"></a> -->
                                <h3 class="text-white">Check Your Results</h3>
                            </div>
                        </div>
                        <div class="panel-body p-20">
                            ...
                            <form action="result.php" method="post" class="admin-login">
                                <div class="form-group">
                                    <label for="rollid" class="control-label">Enter your ID Roll</label>
                                    <input type="text" class="form-control" id="rollid" placeholder="ID Student" autocomplete="off" name="rollid">
                                </div>
                                <div class="form-group">
                                    <label for="default" class="control-label">Grade</label>
                                ...
                                <div class="col-sm-6">
                                    <a href="index.php" class="text-white">Return</a>
                                </div>
                            </form>
