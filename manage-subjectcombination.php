            ...
            <div class="main-page">
                <div class="container-fluid">
                    <div class="row page-title-div">
                        <div class="col-md-6">
                            <h2 class="title">Manage Courses Relationship  </h2>
                    ...
                    <div class="row breadcrumb-div">
                        <div class="col-md-6">
                            <ul class="breadcrumb">
                                ...
                                <li> Courses</li>
                                <li class="active">Manage Courses Relationship</li>
                            </ul>
                        </div>
                                ...
                                <div class="panel">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <h5>View Course Relationship Information</h5>
                                        </div>
                                    </div>
                                    <?php if ($msg) { ?>
