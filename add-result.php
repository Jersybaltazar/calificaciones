                    ...
                    <div class="row breadcrumb-div">
                        <div class="col-md-6">
                            <ul class="breadcrumb">
                                ...
                                <li class="active">Add ratings</li>
                            </ul>
                        </div>
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form class="" method="post">
                                            ...
                                            <div class="form-group">
                                                <label for="date" class=" control-label ">Name of the student</label>
                                            ...
                                            <div class="form-group">
                                                <label for="date" class="control-label">Course</label>
                                                <div id="subject">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <button type="submit" name="submit" id="submit" class="btn btn-success">Display results</button>
