            ...
            <div class="content-container">
                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <!-- /.row -->
                        <h1><span class="blue">&lt;</span>Results<span class="blue">&gt;</span> <span class="yellow">Student</pan>
                        </h1>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 col-md-offset-2">
                                            ...
                                            <div class="panel-title">
                                                ...
                                                if ($stmt->rowCount() > 0) {
                                                    foreach ($resultss as $row) {   ?>
                                                        ...
                                                        <p><b>School year:</b> <?php echo htmlentities($row->ClassName); 
                                                        ?>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php } else { ?>
                                                            <div class="alert alert-warning left-icon-alert" role="alert">
                                                                <strong>Important!</strong> Your results have not been declared yet.
                                                            <?php }
                                                            ?>
                                                            </div>
                                                        <?php
                                                            ...
                                                            <div class="alert alert-danger left-icon-alert" role="alert">
                                                                <strong>There were inconveniences!</strong>
                                                            <?php
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <a href="index.php" style="color:white;">return</a>
                                        </div>
                                    </div>
