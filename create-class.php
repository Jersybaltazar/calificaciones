                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form method="post">
                                            <div class="form-group has-success">
                                                <label for="success" class="control-label">Name Grade</label>
                                                <div class="">
                                                    <input type="text" name="classname" class="form-control" required="required" id="success">
                                                    <span class="help-block">You can put First, Second, or something like that</span>
                                                </div>
                                            </div>
                                            <div class="form-group has-success">
                                                <label for="success" class="control-label">Grade in number</label>
                                                <div class="">
                                                    <input type="number" name="classnamenumeric" required="required" class="form-control" id="success">
                                                    <span class="help-block">You can put 1,2,3 ...</span>
                                                </div>
                                            </div>
                                            <div class="form-group has-success">
                                                ...
                                                <div class="">
                                                    ...
                                                    <span class="help-block">You can put A, B, C ...</span>
                                                </div>
                                            </div>
                                            <div class="form-group has-success">
