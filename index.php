    ...
    <div class="row py-2 px-lg-5">
      <div class="col-lg-6 text-center text-lg-left mb-2 mb-lg-0">
        <div class="d-inline-flex align-items-center text-white">
          <small><i class="fa fa-phone-alt mr-2"></i>941714079</small>
          <small class="px-3">|</small>
          <small><i class="fa fa-envelope mr-2"></i>jersybaltazarc.com</small>
        </div>
      </div>
      <div class="col-lg-6 text-center text-lg-right">
        <div class="d-inline-flex align-items-center">
          <a class="text-white px-2" href="https://github.com/Jersybaltazar" >
  ...
  <div class="container-fluid p-0">
    <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-lg-5">
      <a href="" class="navbar-brand ml-lg-3">
        <h1 class="m-0 text-uppercase text-primary"><i class="fa fa-book-reader mr-3"></i>School of Jersy</h1>
      </a>
      ...
      <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
        <div class="navbar-nav mx-auto py-0">
          ...
          <div class="nav-item dropdown">
            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Páges</a>
        ...
        <a href="find-result.php" class="btn btn-primary py-2 px-4 d-none d-lg-block">Estudents</a>
      ...
      <div class="row">
        ...
        <div class="col-lg-7">
          <div class="section-title position-relative mb-4">
            <h6 class="d-inline-block position-relative text-secondary text-uppercase pb-2">About me</h6>
            <h1 class="display-4">Top choice for online education anywhere.</h1>
          </div>
      ...
      <div class="row">
        <div class="col-lg-7 my-5 pt-5 pb-lg-5">
          <div class="section-title position-relative mb-4">
            ...
            <h1 class="display-4">Why should you start learning with us?</h1>
          </div>
    ...
    <div class="container py-5">
      <div class="row align-items-center">
        <div class="col-lg-5 mb-5 mb-lg-0">
          <div class="section-title position-relative mb-4">
            <h6 class="d-inline-block position-relative text-secondary text-uppercase pb-2">Testimony</h6>
          ...
          <div class="bg-light d-flex flex-column justify-content-center px-5" style="height: 450px;">
            <div class="d-flex align-items-center mb-5">
              ...
              <div class="mt-n1">
                ...
                <p class="m-0">Amarillis, Huanuco, Peru</p>
              </div>
            </div>
            <div class="d-flex align-items-center mb-5">
              <div class="btn-icon bg-secondary mr-4">
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="mt-n1">
                <h4>Correo</h4>
                <p class="m-0">jersybaltazarc.com</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="container mt-5 pt-5">
      ...
      <div class="row">
        <div class="col-md-4 mb-5">
          ...
          <p><i class="fa fa-map-marker-alt mr-2"></i>Amarillis, Huanuco, Peru</p>
          <p><i class="fa fa-phone-alt mr-2"></i>+51914741069</p>
          <p><i class="fa fa-envelope mr-2"></i>jersybaltazarc@gmail.com</p>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 text-center text-md-left mb-3 mb-md-0">
          <p class="m-0"><a class="text-white" href="">Para más desarrollos </a>
          </p>
        </div>
      </div>
    </div>
